...
df = pd.read_csv('train_allfeature_ed_PEARSON.csv').dropna(how='all')
...
cbar.ax.yaxis.label.set_fontproperties({'family': 'Arial', 'size': 6})
cbar.ax.tick_params(labelsize=18)
plt.tight_layout()
plt.savefig('correlation_heatmap_enger.png', dpi=800)
plt.show()